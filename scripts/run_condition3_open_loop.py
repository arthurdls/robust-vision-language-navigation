...
def run_open_loop_control_loop(
    ...
    run_info = {
        ...
        # Always frame mode: C3 runs the open-loop control loop with
        # frame-based convergence detection. Recorded for schema parity
        # with C0/C2/C4/C5/C6.
        "diary_mode": "frame",
        "task": task,
        "seed": seed,
...
def main():
    ...
    tasks = resolve_eval_tasks(args, map_info, SHARED_TASKS_DIR, overrides={"max_steps_per_subgoal": "max_steps_per_subgoal"})
